...
describe('Controller functions for /employees', () => {
  ...
  describe('getAllController', () => {
    ...
    it('should retrieve all employees for the user-managed facility', async () => {
  ...
  describe('createController', () => {
    ...
    it('should return 400 when user does not manage a facility', async () => {
      ...
      expect(res._getJSONData()).toEqual({message: 'User does not manage a facility'});
    });

    it('should return 400 on database error during employee creation', async () => {
      Employee.prototype.save = jest.fn().mockRejectedValue(new Error('Database error'));
  ...
  describe('deleteController', () => {
    ...
    it('should return 500 on database error during deletion', async () => {
      ...
      res.employee.deleteOne = jest.fn().mockRejectedValue(new Error('Database error'));
